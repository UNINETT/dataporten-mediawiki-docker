...
RUN git clone https://github.com/kasperrt/MediaWiki-OAuth2-Dataporten.git /OAuth2Dataporten
...
RUN echo 'php /var/www/html/maintenance/update.php --conf /var/www/html/LocalSettings.php --quick --quiet' >> /entrypoint.sh
